...
const zhCN: Record<string, string> = {
  ...
  "quickPick.command.addFileExplorerTab": "添加文件浏览标签",
  "quickPick.command.addRepoWikiTab": "添加仓库 Wiki 标签",
  ...
  "sidePane.review": "审查",
  "sidePane.fileExplorer": "文件",
  "sidePane.repoWiki": "Wiki",
  "codeViewer.unsaved": "未保存",
  "codeViewer.save": "保存",
  "codeViewer.saved": "已保存",
  "codeViewer.saveFailed": "保存失败：{message}",
  "codeViewer.unsavedChanges.title": "放弃未保存的修改？",
  "codeViewer.unsavedChanges.description": "{count} 个标签页有未保存的编辑，关闭后将丢失。",
  "codeViewer.unsavedChanges.confirm": "丢弃修改",
  "repoWiki.loading": "正在读取 Wiki…",
  "repoWiki.pages": "页面",
  "repoWiki.generate": "生成 Wiki",
  "repoWiki.regenerate": "重新生成",
  "repoWiki.refresh": "刷新",
  "repoWiki.generationStarted":
    "已在后台任务中开始生成 Repo Wiki；目录出现后即可在右侧边读边等，生成会话可在任务列表查看。",
  "repoWiki.generationFailed": "未能发起 Wiki 生成任务，请稍后重试。",
  "repoWiki.openFromTree": "打开仓库 Wiki",
  "repoWiki.wikiTitle": "Repo Wiki",
  "repoWiki.backToChat": "返回对话",
  "repoWiki.catalog": "目录",
  "repoWiki.updatedAt": "更新于",
  "repoWiki.sources": "来源",
  "repoWiki.selectPage": "从左侧目录选择页面",
  "repoWiki.card.title": "生成 Repo Wiki",
  "repoWiki.card.desc":
    "Agent 通读代码库，产出一份子系统深潜指南：分组目录、每页配 mermaid 图与行级源码出处；此前用官方版生成的 Wiki 也可直接阅读。",
  "repoWiki.card.language": "语言",
  "repoWiki.card.languageValue": "跟随界面语言",
  "repoWiki.card.model": "模型",
  "repoWiki.card.modelValue": "使用新任务默认模型",
  "repoWiki.card.storage": "存储",
  "repoWiki.card.generateHint":
    "点击后自动开始生成；目录会先出现，页面逐页补齐，随时可以边读边等。",
  "repoWiki.delete": "删除 Wiki",
  "repoWiki.delete.title": "删除 Repo Wiki？",
  "repoWiki.delete.description": "将删除 {path}；之后可随时重新生成。",
  "repoWiki.delete.confirm": "删除",
  "repoWiki.delete.cancel": "取消",
  "repoWiki.deleted": "Wiki 已删除。",
  "repoWiki.deleteFailed": "删除 Wiki 失败，请重试。",
  "repoWiki.language.zhCN": "简体中文",
  "repoWiki.language.enUS": "English",
  "repoWiki.model.default": "默认模型",
  "repoWiki.diagrams": "生成图表",
  "repoWiki.meta.language": "语言",
  "repoWiki.meta.updatedAt": "更新时间",
  "repoWiki.meta.commit": "提交 ID",
  "repoWiki.meta.files": "Wiki 文件",
  "repoWiki.meta.badge": "元数据",
  "repoWiki.stop": "停止",
  "repoWiki.progress.pages": "正在生成页面",
  "repoWiki.progress.analyzing": "正在分析代码库",
  "repoWiki.pageStatus.generating": "正在生成",
  "repoWiki.pageStatus.waiting": "等待生成",
  "repoWiki.pageStatus.failed": "生成失败",
  "repoWiki.failedCount": "失败 {count} 页",
  "repoWiki.retry": "重试 {count} 次",
  "repoWiki.retryCountLabel": "重试次数",
  "repoWiki.retry.hint": "单页生成失败时的自动重试次数",
  "repoWiki.catalog.collapse": "收起目录",
  "repoWiki.catalog.expand": "展开目录",
  "whiteboard.title": "画板",
  ...
  "settings.appearance.customizeLightTitle": "浅色主题",
  "settings.appearance.customizeDarkTitle": "深色主题",
  "settings.appearance.accent": "强调色",
  "settings.appearance.background": "背景",
  "settings.appearance.foreground": "前景",
  "settings.appearance.accentSource.default": "默认",
  "settings.appearance.accentSource.custom": "自定义",
  "settings.appearance.uiFont": "UI 字体",
  "settings.appearance.contentFont": "内容字体",
  "settings.appearance.codeFont": "代码字体",
  "settings.appearance.fontOption.system": "系统默认",
  "settings.appearance.fontOption.sans": "系统无衬线",
  "settings.appearance.fontOption.serif": "衬线体",
  "settings.appearance.fontOption.mono": "等宽体",
  "settings.appearance.fontOption.sameAsUi": "与界面字体相同",
  ...
  "settings.appearance.fontWeight.400": "常规",
  "settings.appearance.fontWeight.500": "中等",
  "settings.appearance.fontWeight.600": "半粗",
  "settings.appearance.translucentSidebar": "半透明侧边栏",
  "settings.appearance.contrast": "对比度",
  "settings.appearance.resetColor": "恢复默认颜色",
  "settings.appearance.importTheme": "导入",
  "settings.appearance.copyTheme": "复制主题",
  "settings.appearance.importDialogTitle": "导入主题",
  "settings.appearance.importDialogDescription":
    "粘贴主题 JSON（可通过「复制主题」获得），应用后覆盖该模式的颜色与对比度。",
  "settings.appearance.importDialogPlaceholder": '{ "version": 1, ... }',
  "settings.appearance.importDialogApply": "应用",
  "settings.appearance.importDialogCancel": "取消",
  "settings.appearance.importError.invalidJson": "JSON 格式无效，请检查粘贴内容。",
  "settings.appearance.importError.unsupportedVersion": "不支持的主题版本（需要 version: 1）。",
  "settings.appearance.importError.invalidMode": "无效的主题模式（需要 light 或 dark）。",
  "settings.appearance.importError.invalidColors": "颜色字段无效（需要 #RRGGBB 颜色或 null）。",
  "settings.appearance.previewTitle": "外观预览",
  "settings.appearance.previewToggle": "切换代码 / 文字样例",
  "settings.appearance.preset.default": "默认",
  "settings.appearance.preset.codex": "Codex",
  "settings.appearance.preset.custom": "自定义",
  "settings.appearance.preferencesTitle": "偏好设置",
  "settings.appearance.pointerCursor": "使用指针光标",
  "settings.appearance.pointerCursorDescription": "在按钮、下拉和链接上显示手型光标。",
