...
const enUS: Record<string, string> = {
  ...
  "quickPick.command.addFileExplorerTab": "Add file explorer tab",
  "quickPick.command.addRepoWikiTab": "Add repo wiki tab",
  ...
  "sidePane.fileExplorer": "Files",
  "sidePane.repoWiki": "Wiki",
  "codeViewer.unsaved": "Unsaved",
  "codeViewer.save": "Save",
  "codeViewer.saved": "Saved",
  "codeViewer.saveFailed": "Save failed: {message}",
  "codeViewer.unsavedChanges.title": "Discard unsaved changes?",
  "codeViewer.unsavedChanges.description": "{count} tab(s) have unsaved edits that will be lost.",
  "codeViewer.unsavedChanges.confirm": "Discard changes",
  "repoWiki.loading": "Loading wiki…",
  "repoWiki.pages": "Pages",
  "repoWiki.generate": "Generate wiki",
  "repoWiki.regenerate": "Regenerate",
  "repoWiki.refresh": "Refresh",
  "repoWiki.generationStarted":
    "Wiki generation started in a background task — start reading as soon as the catalog appears; the generation session shows up in your task list.",
  "repoWiki.generationFailed": "Couldn't start the wiki generation task. Please try again.",
  "repoWiki.openFromTree": "Open repo wiki",
  "repoWiki.wikiTitle": "Repo Wiki",
  "repoWiki.backToChat": "Back to conversation",
  "repoWiki.catalog": "Catalog",
  "repoWiki.updatedAt": "Updated",
  "repoWiki.sources": "Sources",
  "repoWiki.selectPage": "Pick a page from the catalog",
  "repoWiki.card.title": "Generate a Repo Wiki",
  "repoWiki.card.desc":
    "The agent reads the codebase and produces a subsystem deep-dive guide: a grouped catalog with a mermaid diagram and line-level source references on every page. Wikis generated by the official app can be read directly.",
  "repoWiki.card.language": "Language",
  "repoWiki.card.languageValue": "Follows interface language",
  "repoWiki.card.model": "Model",
  "repoWiki.card.modelValue": "Uses the default model for new tasks",
  "repoWiki.card.storage": "Storage",
  "repoWiki.card.generateHint":
    "Generation starts immediately; the catalog appears first and pages fill in one by one — start reading right away.",
  "repoWiki.delete": "Delete wiki",
  "repoWiki.delete.title": "Delete this Repo Wiki?",
  "repoWiki.delete.description": "This deletes {path}. You can regenerate it at any time.",
  "repoWiki.delete.confirm": "Delete",
  "repoWiki.delete.cancel": "Cancel",
  "repoWiki.deleted": "Wiki deleted.",
  "repoWiki.deleteFailed": "Couldn't delete the wiki. Please try again.",
  "repoWiki.language.zhCN": "简体中文",
  "repoWiki.language.enUS": "English",
  "repoWiki.model.default": "Default model",
  "repoWiki.diagrams": "Diagrams",
  "repoWiki.meta.language": "Language",
  "repoWiki.meta.updatedAt": "Updated",
  "repoWiki.meta.commit": "Commit",
  "repoWiki.meta.files": "Wiki files",
  "repoWiki.meta.badge": "Metadata",
  "repoWiki.stop": "Stop",
  "repoWiki.progress.pages": "Generating pages",
  "repoWiki.progress.analyzing": "Analyzing the codebase",
  "repoWiki.pageStatus.generating": "Generating",
  "repoWiki.pageStatus.waiting": "Waiting",
  "repoWiki.pageStatus.failed": "Failed",
  "repoWiki.failedCount": "{count} page(s) failed",
  "repoWiki.retry": "Retry {count}×",
  "repoWiki.retryCountLabel": "Retries",
  "repoWiki.retry.hint": "Automatic retries when a single page fails to generate",
  "repoWiki.catalog.collapse": "Collapse catalog",
  "repoWiki.catalog.expand": "Expand catalog",
  ...
  "settings.appearance.customizeLightTitle": "Light theme",
  "settings.appearance.customizeDarkTitle": "Dark theme",
  ...
  "settings.appearance.accentSource.default": "Default",
  "settings.appearance.accentSource.custom": "Custom",
  "settings.appearance.uiFont": "UI font",
  "settings.appearance.contentFont": "Content font",
  "settings.appearance.codeFont": "Code font",
  "settings.appearance.fontOption.system": "System default",
  "settings.appearance.fontOption.sans": "System sans-serif",
  "settings.appearance.fontOption.serif": "Serif",
  "settings.appearance.fontOption.mono": "Monospace",
  "settings.appearance.fontOption.sameAsUi": "Same as UI font",
  "settings.appearance.codeFontOption.menlo": "Menlo (macOS)",
  "settings.appearance.codeFontOption.consolas": "Consolas (Windows)",
  "settings.appearance.codeFontOption.cascadia": "Cascadia Code",
  "settings.appearance.codeFontOption.jetbrains": "JetBrains Mono",
  "settings.appearance.codeFontOption.fira": "Fira Code",
  "settings.appearance.fontWeight.400": "Regular",
  "settings.appearance.fontWeight.500": "Medium",
  "settings.appearance.fontWeight.600": "Semibold",
  "settings.appearance.translucentSidebar": "Translucent sidebar",
  "settings.appearance.contrast": "Contrast",
  "settings.appearance.resetColor": "Reset to default color",
  "settings.appearance.importTheme": "Import",
  "settings.appearance.copyTheme": "Copy theme",
  "settings.appearance.importDialogTitle": "Import theme",
  "settings.appearance.importDialogDescription":
    'Paste a theme JSON (available via "Copy theme"). Applying it overrides that mode\'s colors and contrast.',
  "settings.appearance.importDialogPlaceholder": '{ "version": 1, ... }',
  "settings.appearance.importDialogApply": "Apply",
  "settings.appearance.importDialogCancel": "Cancel",
  "settings.appearance.importError.invalidJson": "Invalid JSON. Please check the pasted content.",
  "settings.appearance.importError.unsupportedVersion":
    "Unsupported theme version (expected version: 1).",
  "settings.appearance.importError.invalidMode": "Invalid theme mode (expected light or dark).",
  "settings.appearance.importError.invalidColors":
    "Invalid color fields (expected #RRGGBB colors or null).",
  "settings.appearance.previewTitle": "Appearance preview",
  "settings.appearance.previewToggle": "Toggle code / text sample",
  "settings.appearance.preset.default": "Default",
  "settings.appearance.preset.codex": "Codex",
  "settings.appearance.preset.custom": "Custom",
  "settings.appearance.preferencesTitle": "Preferences",
  "settings.appearance.pointerCursor": "Use pointer cursor",
  "settings.appearance.pointerCursorDescription":
    "Show a hand cursor on buttons, dropdowns, and links.",
